...
const Input:React.FC<InputProps> = ({id,onChange,value,label,type}) => {
    return (
        <div className='relative'>
            <input type={type} value={value} id={id} onChange={onChange} className='block bg-neutral-700 text-white px-6 text-md pt-6 pb-1 rounded-md appearance-none focus:ring-0 focus:outline-none peer' placeholder=' ' />
